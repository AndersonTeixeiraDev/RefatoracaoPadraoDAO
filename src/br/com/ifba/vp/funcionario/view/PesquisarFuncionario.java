...
public class PesquisarFuncionario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List <FuncionarioCaixa> buscaFuncionario = (List <FuncionarioCaixa>) Singleton.getInstance().findByNomeFuncionario(this.Nome.getText());        
       
        for(int i = 0 ; i < buscaFuncionario.size(); i++){
            y++;
            modelo.addRow(new Object[]{
                        
                buscaFuncionario.get(i).getNome(),
                buscaFuncionario.get(i).getRG(),
            });
        }
